...
class NukexDecomposer(TaskDecomposer):

    def __init__(self, task):
        self.task = task
        task.runner = "puliclient.contrib.nukex.NukexRunner"
...
class NukexRunner(CommandRunner):
    def execute(self, arguments, updateCompletion, updateMessage):
        # init the helper
        self.helper = PuliActionHelper()
        ...
        # init log
        self.helper.printStartLog("NukeXRunner", "1.0")
