...
from octopus.core.framework.webservice import WebService, MappingSet
import tornado
import httplib
import json
...
__all__ = ['WSAppFramework', 'WebService', 'MainLoopApplication']
...
#        logger.debug("controller %s called with request=%s, path=%s, args=%s", self.root, repr(request), repr(path), args)
